...
#l1, = axs[0].plot(chnl_2[0:10000], c='b', label='EMG Signal',linewidth=1.0)
l2, = axs[0].plot(ftg_sng[0:250], c='m', label='Synergy Activation',linewidth=1.0)
axs[0].legend(handles=[l2],loc='upper right')
axs[0].axes.xaxis.set_visible(False)
#l3, = axs[1].plot(chnl_2[0:2000], c='b', label='EMG Signal',linewidth=1.0)
l4, = axs[1].plot(ftg_sng[1750:2000], c='m', label='Synergy Activation',linewidth=1.0)
axs[1].legend(handles=[l4],loc='upper right')
