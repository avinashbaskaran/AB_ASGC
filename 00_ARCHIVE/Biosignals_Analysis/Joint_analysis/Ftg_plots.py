...
for i in range(0, 7200,1):#7200, int(lenSigs/lenWindow),1):
    ...
    ftg_sng = np.fft.fftshift(tfr_wvd, axes=0)
...
axs[1].set_xlabel('time (10 ms epochs)')
...
l2, = axs[1].plot(TFR_, c='r', label ='Frequency [Hz]',linewidth=1.0)
axs[1].legend(handles=[l2],loc='upper right')
#axs[1].axes.yaxis.set_visible(False)

f = open('C:/Users/azb0180/Downloads/Github/WeBR/ASGC_2021/Software/SUPPORT/Test_data/EMG_dataset1/DBs_raw/Database_2/ASGC_2022_chnl2export.csv', 'w')
g = open('C:/Users/azb0180/Downloads/Github/WeBR/ASGC_2021/Software/SUPPORT/Test_data/EMG_dataset1/DBs_raw/Database_2/ASGC_2022_TFRexport.csv', 'w')
writer1 = csv.writer(f)
writer1.writerow(chnl_2)
writer2 = csv.writer(g)
writer2.writerow(TFR_)
f.close()
g.close()
